                    ...
                    <table id="lecturerTable" class="table dataTable no-footer"  aria-describedby="datatable1_info">
                        ...
                        @foreach($classrooms as $classroom)
                            <tr role="row" class="odd">
                                <td class="sorting_1">
                                    <a href="{{route('admin/lecturer/allProfiles/view/',$classroom->lecturer->id)}}">{{$classroom->lecturer->user->first_name}}</a>
                                </td>
                                ...
                                <td>
                                    ...
                                    No students
                                    @else
                                        <a href="{{route('admin/classroom/profiles/',$classroom->id)}}">
