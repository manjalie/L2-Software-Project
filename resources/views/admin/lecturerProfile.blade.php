...
@section('breadcrumb')
    <ul class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{route('admin/lecturer/allProfiles')}}"> Lecturer  Profiles</a></li>
        ...
        <div class="row">
            <div class="col-lg-4 ">
                ...
                <div class="card card-profile ">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        @if ($lecturer->cv !== null)
                            <li class="list-group-item">
                                ...
                                CV <a href="{{asset('Docs/Lecturer/'.$lecturer->cv)}}" target="_blank">view</a>
                            </li>
                        @endif
                    ...
                    <div class="card-body">
                        <div class="card-link">
                            @if ($lecturer->user->status == 'blocked')
                                <a href="{{route('admin/lecturer/allProfiles/unblock/',$lecturer->id)}}" data-toggle="confirmation" data-title="Unblock user?">Unblock</a>
                            @else
                                <a href="{{route('admin/lecturer/allProfiles/block/',$lecturer->id)}}" data-toggle="confirmation" data-title="Block user?">Block</a>
                            @endif
                        </div>
                    </div>
                </div>
