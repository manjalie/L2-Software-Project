        ...
        <div class="row">
            ...
            <div class="col-lg-8  col-md-8">
                <div class="card">
                    ...
                    <div class="form  ">
                        <div class="content">
                            <form class="text-left form-validate"  method="POST" action="{{route('student/profile/updateProfile')}}">
                                <div class="card-body">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="form-group-material col-md-6 col-sm-12 col-lg-6">
                                            <label>Mobile  </label>
                                            <input  type="text"  data-msg="Please enter a valid mobile no" data-mask="(999) 9999999" required class="form-control" name="mobile" value="{{ $student->mobile_no  }}">
                                            <small class="help-block-none">e.g (071) 9999999</small>
                                        </div>
                                        {{-------------------Address---------------------------------------}}
                                        <div class="form-group-material col-md-6 col-sm-12 col-lg-6">
                                            <label >Address</label>
                                            <input  type="text"  data-msg="Please enter a valid address" required class="form-control" name="address" value="{{ $student->address  }}">
                                            <small class="help-block-none">e.g No:15,galle rd.</small>
                                        </div>
                                        {{-------------------City---------------------------------------}}
                                        <div class="form-group-material col-md-6 col-sm-12 col-lg-6">
                                            <label >City </label>
                                            <input  type="text"  data-msg="Please enter a valid city" required class="form-control" name="city" value="{{ $student->city  }}">
                                            <small class="help-block-none">e.g Colombo.</small>
                                        </div>
                                        {{-------------------NIC No---------------------------------------}}
                                        <div class="form-group-material col-md-6 col-sm-12 col-lg-6">
                                            <label >NIC No      </label>
                                            <input id="register-nic" type="number"  data-msg="Please enter a valid nic" required class="form-control" name="nic" value="{{ $student->nic_no  }}">
                                        ...
                                        <div class="form-group-material col-md-6 col-sm-12 col-lg-6">
                                            <label >DOB      </label>
                                            @if ($student->dob == null)
                                                <input id="register-dob" type="text"  data-msg="Please enter a valid birthday" required class="form-control input-datepicker-autoclose" name="dob" value="02/01/1993" readonly>
                                            @else
                                                <input id="register-dob" type="text"  data-msg="Please enter a valid birthday" required class="form-control input-datepicker-autoclose" name="dob" value="{{\Carbon\Carbon::parse($student->dob)->format('m/d/Y') }}" readonly>
                                            @endif
    ...
    <div class="modal fade" id="changepasswordModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <form class="text-left form-validate"  method="POST" action="{{route('student/profile/updatePassword')}}">
