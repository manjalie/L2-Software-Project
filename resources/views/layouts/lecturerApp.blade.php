        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
            ...
            <div class="right-menu list-inline no-margin-bottom">
                ...
                <div class="list-inline-item dropdown"><a id="navbarDropdownMenuLink2" href="http://example.com" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link tasks-toggle">
                        ...
                        <span class="badge dashbg-3">{{count($requests )}}</span></a>
                    <div aria-labelledby="navbarDropdownMenuLink2" class="dropdown-menu tasks-list">

                        @foreach ($requests as $request)
                            <a href="{{route('lecturer/classrooms/requests')}}" class="dropdown-item">
                                <div class="text d-flex justify-content-between">
                                    <strong>{{$request->student_class_request->subject->name}}</strong>
                                </div>
                                <small>{{$request->created_at}}</small>
                            </a>
                        @endforeach

                        <a href="{{route('lecturer/classrooms/requests')}}" class="dropdown-item text-center"> <strong>See All Requests <i class="fa fa-angle-right"></i></strong></a>
                    </div>
                </div>
                <!-- Tasks end-->
...
<div class="d-flex align-items-stretch">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled">
            <li class=" {{ Request::path() == 'lecturer' ? 'active' : '' }} "><a href="{{route('lecturer')}}"> <i class="icon-home"></i>Home </a></li>
            <li class="{{ Request::segment(2) == 'newCourse' ? 'active' : '' }} "><a href="{{route('lecturer/newCourse')}}"> <i class="icon-new-file"></i>Apply New Course</a></li>
            <li class="{{ Request::path() == 'lecturer/availableCourses' ? 'active' : '' }} "><a href="{{route('lecturer/availableCourses')}}"> <i class="icon-list"></i>Available Courses</a></li>
            <li class ="{{ Request::segment(2) == 'classrooms' ? 'active' : '' }}"><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-paper-and-pencil"></i>Classrooms</a>
                <ul id="exampledropdownDropdown" class="collapse list-unstyled ">
                    <li><a href="{{route('lecturer/classrooms/all')}}">My Classes</a></li>
                    <li><a href="{{route('lecturer/classrooms/requests')}}">Class Requests</a></li>
                </ul>
            </li>
            <li class="{{ Request::path() == 'lecturer/applyHistory' ? 'active' : '' }} "><a href="{{route('lecturer/applyHistory')}}">
                    <i class="icon-writing-whiteboard"></i>Applied Courses</a>
            </li>
        </ul>
    </nav>
